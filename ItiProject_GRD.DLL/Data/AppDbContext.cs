...
namespace ItiProject_GRD.DLL.Data
{
    public class AppDbContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                ...
                new User { Id = 2, Name = "Abdo Salem", Email = "Abdo@test.com", Role = Role.Instructor },
                new User { Id = 3, Name = "Adel Tamer", Email = "Adel@test.com", Role = Role.Trainee },
                new User { Id = 4, Name = "Asser", Email = "asser@test.com", Role = Role.Trainee }
            );
