...
namespace ItiProject_GRD.Controllers
{
    public class SessionController : Controller
    {
        ...
        public SessionController(ISessionService sessionService, ICourseService courseService, IOptions<PaginationOptions> paginationOptions)
        {
        ...
        // Index مع بحث + Pagination + filter بالكورس لو جاي من زرار View Sessions
