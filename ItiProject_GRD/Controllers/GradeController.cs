...
using ItiProject_GRD.BLL.Services; // adjust namespaces as in your project
...
namespace ItiProject_GRD.Controllers
{
    public class GradesController : Controller
    {
        ...
        // GET: Grades (kept as you already have)
        ...
        {
            // server side: ensure selection was made (value != 0)
            if (vm.SessionId == 0)
            {
        ...
        // Delete & TraineeGrades as before...
